...
import static sertyo.events.utility.ab.AutoBuyGui.getStringIgnoreLastChar;
import static sertyo.events.utility.ab.AutoBuyGui.isHover;
...
public class SelectWindow {
    ...
    public void render(int mx, int my) {
        ...
        RenderUtil.Render2D.drawRoundedRect((float) x, (float) y, (float) w, (float) h, 4, new Color(39, 37, 37, 255).getRGB());
        ...
        RenderUtil.Render2D.drawRoundedRect((float) (x + 4), (float) (y + 4), (float) (w - 8), 20, 2, new Color(16, 15, 15, 255).getRGB());
        ...
        RenderUtil.Render2D.drawRoundedRect((float) (x + w - 4 - IFont.getWidth(IFont.MONTSERRAT_MEDIUM, reset, 8) - 6), (float) (y + 4 + 10 - IFont.getHeight(IFont.MONTSERRAT_MEDIUM, reset, 8) / 2 - 1), IFont.getWidth(IFont.MONTSERRAT_MEDIUM, reset, 8) + 4, IFont.getHeight(IFont.MONTSERRAT_MEDIUM, reset, 8) + 2, 2, new Color(43, 44, 44, 255).getRGB());
