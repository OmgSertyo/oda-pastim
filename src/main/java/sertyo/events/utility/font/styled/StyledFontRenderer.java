...
public final class StyledFontRenderer implements Wrapper {
    ...
    public static float drawString(MatrixStack matrices, StyledFont font, String text, double x, double y, Color color1, Color color2) {
        return renderString(matrices, font, text, x, y, false, color1, color2);
    }
    ...
    private static float renderString(MatrixStack matrices, StyledFont font, String text, double x, double y, boolean shadow, Color color1, Color color2) {
        y -= 3;
        GL11.glColor4f(1, 1, 1, 1);
