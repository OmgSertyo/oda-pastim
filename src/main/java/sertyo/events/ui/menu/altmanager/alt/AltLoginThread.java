...
public class AltLoginThread extends Thread {
   ...
   public Session login(String name, String password) {
      ...
      UserAuthentication authentication = new YggdrasilUserAuthentication(service, null, Agent.MINECRAFT);
   ...
   public void run() {
      if (this.alt.getPassword().equals("")) {
         ...
         this.status = TextFormatting.GREEN + "Logged in - " + TextFormatting.WHITE + this.alt.getUsername() + TextFormatting.BOLD + TextFormatting.RED + " (Not License)";
      } else {
