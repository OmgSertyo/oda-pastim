package sertyo.events.ui.menu.main.widgets;
...
public class PasswordField extends Widget implements IRenderable, IGuiEventListener
{
    ...
    public PasswordField(FontRenderer fontrendererObj, int componentId, int x, int y, int width, ITextComponent p_i232260_6_)
    {
        this(fontrendererObj, componentId, x, y, width, (PasswordField)null, p_i232260_6_);
    }

    public PasswordField(FontRenderer p_i232259_1_, int p_i232259_2_, int p_i232259_3_, int p_i232259_4_, int p_i232259_5_, @Nullable PasswordField p_i232259_6_, ITextComponent p_i232259_7_)
    {
    ...
    public void renderButton(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks)
    {
        if (this.getVisible())
        {
            ...
            if (flag1)
            {
                ...
                {
                    Fonts.mntsb17.drawStringWithShadow("_", (float)k1 + 1.0F, (float)i1 + 1.5F, i2);
