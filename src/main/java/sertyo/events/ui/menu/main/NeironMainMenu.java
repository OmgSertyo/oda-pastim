...
public class NeironMainMenu extends Screen {
   ...
   public void render(MatrixStack ms, int mouseX, int mouseY, float partialTicks) {
    ...
    //  });
      ...
      sertyo.events.utility.font.Fonts.msBold[17].drawString(Main.getInstance().getUsername(), (float)(scaledWidth - 50 - sertyo.events.utility.font.Fonts.msBold[17].getWidth(Main.getInstance().getUsername())), 20.0F, -1);
      sertyo.events.utility.font.Fonts.msBold[16].drawString("UID: " + Main.getInstance().getUid(), (float)(scaledWidth - 50 - sertyo.events.utility.font.Fonts.msBold[16].getWidth("UID: " + Main.getInstance().getUid())), 30.0F, (new Color(120, 120, 120)).getRGB());
      Fonts.tenacityBold35.drawGradientString("Neiron", (double)((float)scaledWidth / 2.0F - 14.0F), (double)((float)scaledHeight / 2.0F - 65.0F), color, color2);
