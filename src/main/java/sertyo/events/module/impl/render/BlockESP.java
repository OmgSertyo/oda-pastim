...
public class BlockESP extends Module {
   ...
   public BlockESP() {
      this.spawnerColor = new ColorSetting("Spawner Color", Color.YELLOW.getRGB(), () -> this.blocks.get(0));
      this.chestColor = new ColorSetting("Chest Color", Color.ORANGE.getRGB(), () -> this.blocks.get(1));
      this.enderChestColor = new ColorSetting("Ender Chest Color", Color.MAGENTA.getRGB(), () -> this.blocks.get(2));
      this.shulkerColor = new ColorSetting("Shulker Color", Color.CYAN.getRGB(), () -> this.blocks.get(3));
      this.endPortalColor = new ColorSetting("End Portal Color", Color.GRAY.getRGB(), () -> this.blocks.get(4));
   }

   @EventTarget
   public void onRender3D(EventRender3D event) {

       for (TileEntity entity : Utility.mc.world.loadedTileEntityList) {
