...
@UtilityClass
public class InvUtil implements Utility {
    ...
    private void swapSlotToSlotProcess(int slotAt, int slotTo, TimerHelper timerUtil, EnumWhiteInvActions... whiteInvActions) {
