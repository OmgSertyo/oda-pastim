...
import sertyo.events.event.player.EventItemUsing;
...
public class ClientPlayerEntity extends AbstractClientPlayerEntity
{
    ...
    private void onUpdateWalkingPlayer()
    {
        ...
        EventMotion eventPre = new EventMotion(this.rotationYaw, this.rotationPitch, this.getPositionVec().x, this.getPositionVec().y, this.getPositionVec().y, this.onGround);
